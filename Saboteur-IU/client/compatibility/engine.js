...
var imagenCartas = new function(){
	...
	this.draw = function(contexto, imagen, carta, x, y){
...
var Tablero = function(){
    ...
    this.draw = function(contexto){
        ...
        var tablero = new Array();  // Por ahora se almacena en un array
                                    // pero se puede meter en una base de datos
    	for(i=0;i<2;i++){
                tablero[i] = new Array();
		   	for(j=0;j<15;j++){
                var casilla = new Object();
                casilla.carta = "vacia";
                casilla.x = 456;        //Calcular las coordenadas de cada casilla
                casilla.y = 454;
                tablero[i][j] = casilla;
		   		contexto.strokeStyle = "black";
